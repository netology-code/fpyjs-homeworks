...
### Мотивационный блок:
Выполняя данное задание, вы сможете сделать первые шаги в программировании кода, который будет выполняться на платформе NodeJS, которую также установите в рамках данного задания. Также вы получите начальную практику в использовании синтаксиса JavaScript для написания циклов, функций и использования объектов.
...
```
Необязательная часть задания*. Для сравнения, рекомендуем написать аналогичную программу на Python и сравнить быстродействие программ запуская их на большом значении аргумента, например 100 000 и засекая время. В JS можно засекать время выполнения кода, если до него вызвать функцию console.time() и console.timeEnd() после. Сравните также сложность написания аналогичного кода на Python и JavaScript.
...
2. В случае создания отдельной ветки (branch) для заданий к каждому уроку, ссылка прикрепленная в лк, должна быть на ветку, содержащую решение данного задания.
